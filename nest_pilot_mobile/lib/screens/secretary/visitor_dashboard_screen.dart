            ...
            slivers: [
              SliverToBoxAdapter(
                child: AppDashboardHeader(
                  ...
                  subtitle: 'Monitor society visitor activity',
                  ...
                  stats: [
                    AppHeaderStat(
                      value: _loading ? '—' : '${_data?.insideCount ?? 0}',
                      label: 'Inside',
                      color: AppColors.accentGreen,
                      icon: Icons.person_rounded,
                    ),
                    AppHeaderStat(
                      value: _loading ? '—' : '${_data?.pendingCount ?? 0}',
                      label: 'Pending',
                      color: AppColors.accentOrange,
                      icon: Icons.hourglass_top_rounded,
                    ),
                    AppHeaderStat(
                      value: _loading ? '—' : '${_data?.todayCount ?? 0}',
                      label: 'Today',
          ...
          Row(
            children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () => Navigator.push(context,
                      MaterialPageRoute(builder: (_) => const CurrentVisitorsScreen())),
                  child: const AppIconTile(
