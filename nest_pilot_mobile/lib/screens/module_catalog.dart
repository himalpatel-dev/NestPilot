...
List<ModuleSection> masterModuleSections() => [
  ...
  ModuleSection('Administration', [
    ...
    ModuleTile.gated(
      Icons.location_city_outlined, 'All Societies', AppColors.accentOrange,
      (c) => _go(c, const SocietiesListScreen()),
      ModuleCodes.buildings,
      tags: const ['society list', 'all societies', 'directory', 'view societies', 'edit society'],
    ),
    ModuleTile.gated(
      Icons.domain_outlined, 'All Buildings', AppColors.accentBlue,
  ...
  ModuleSection('System', [
    ...
    ModuleTile.gated(
      Icons.assignment_ind_outlined, 'Secretaries', AppColors.accentGreen,
